    ...
    <header className="flex flex-col gap-3 border-b border-slate-800 bg-slate-950/80 px-4 py-3 backdrop-blur sm:flex-row sm:items-center sm:justify-between sm:px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex shrink-0 items-center gap-1.5 rounded-lg border border-slate-700 bg-slate-900/80 px-3 py-1.5 text-xs font-medium text-slate-300 hover:border-slate-500 hover:text-slate-100"
        >
          <PiggyBank size={14} /> Minha Carteira
          {carteiraCount > 0 && (
